...
from Xadega import CMD_HELP, bot, ubot
from Xadega.config import *
from Xadega.utils.data import *
from Xadega.utils.inline import paginate_help
...
@ubot.on_message(filters.user(OWNER_ID) & filters.command("Xadega", PREFIX))
async def _(c, m):
...
async def _(client, inline_query):
    ...
    logo = "https://telegra.ph//file/b7cc3bcbe25246edda7e2.jpg" if ex is None else ex
    pr = "**Prefix:**"
    for i in PREFIX:
        pr += f" `{i}`"
        ...
        results=[
            (
                InlineQueryResultArticle(
                    thumb_url="https://telegra.ph//file/b7cc3bcbe25246edda7e2.jpg",
                    title="About",
                    reply_markup=InlineKeyboardMarkup(
                        [
                            [
                                InlineKeyboardButton(
                                    "⟨ Support ⟩", url="t.me/xadega"
                                ),
                            ],
                        ]
                    ),
