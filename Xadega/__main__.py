...
from Xadega import Ubot, bot, ubot, LOOP
from Xadega.modules import ALL_MODULES
from Xadega.utils.data import get_userbots, log_info, remove_ubot

from .config import *

msg = """
🔥 **Xadega-Userbot Berhasil Di Aktifkan**
━━
➠ **Python Version** > `{}`
➠ **Pyrogram Version** > `{}`
━━
...
async def main():
    ...
    for all_module in ALL_MODULES:
        importlib.import_module(f"Xadega.modules.{all_module}")
